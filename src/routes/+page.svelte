...
<Seo title="Owen Oertell" description="machine learning." />
<div class="layout-md text-lg space-y-14 my-10">
  <div class="space-y-5">
    <p>
      I study at Cornell University, where I am pursuing a B.S. in Computer
      Science.
    </p>
    <p>
      I am interested in reasoning, decision making (reinforcement learning,
    ...
    <p>
      ...
      >
      and professor
      <a class="link" href="https://www.cs.cornell.edu/~rdk/"
        >Robert Kleinberg</a
      >.
    </p>
    <p>
      Currently, I am a research scientist intern at <a
        class="link"
        href="https://www.databricks.com/">Databricks</a
      >.
    </p>
    <p>
    ...
    <p>
      A picture of me can be found <a
        class="link"
