...
function _page($$renderer) {
  ...
  Workplace($$renderer, {
    ...
    children: ($$renderer2) => {
      $$renderer2.push(`<li>Agents, reinforcement learning, and retrieval</li>`);
    },
    $$slots: { default: true }
  });
  $$renderer.push(`<!----> `);
