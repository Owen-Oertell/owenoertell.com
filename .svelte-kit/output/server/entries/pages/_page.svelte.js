...
function GardenArt($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    $$renderer2.push(`<div class="garden-art svelte-19rh402"><canvas aria-hidden="true" class="svelte-19rh402"></canvas> <p class="caption svelte-19rh402">dithered image of the humble administrator's garden. suzhou, china</p></div>`);
  });
}
