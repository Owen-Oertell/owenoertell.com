...
function GardenArt($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    $$renderer2.push(`<div class="garden-art svelte-19rh402"><canvas aria-hidden="true" class="svelte-19rh402"></canvas> <p class="caption svelte-19rh402">dithered image from my trip to the humble administrator's garden. suzhou, china</p></div>`);
  });
}
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!----> <section class="layout-md text-lg space-y-5 mb-14"><p>I am a research scientist at <a class="link" href="https://www.databricks.com/">Databricks Mosaic Research</a> working on agents, reinforcement learning, and retrieval.</p> <p>I graduated summa cum laude from Cornell University with a B.S. in Computer
    Science where I was fortunate to work with professors <a class="link" href="https://wensun.github.io">Wen Sun</a>, <a class="link" href="https://www.cs.cornell.edu/~rdk/">Robert Kleinberg</a>, and <a class="link" href="https://xkianteb.github.io">Kianté Brantley</a>.</p> <p>I was also previously a research intern at <a class="link" href="https://www.databricks.com/">Databricks Mosaic Research</a>, <a class="link" href="https://www.nvidia.com/">NVIDIA</a>, and a software
    engineering intern at <a class="link" href="https://www.drw.com/">DRW</a>.</p> <p>Outside of research, I enjoy mathematics, <a class="link" href="https://artsandculture.google.com/entity/edward-hopper/m0hc3t">art</a>, music, literature, and drone photography. A picture of me can be found <a class="link" href="assets/images/owen_oertell.png">here</a>.</p> <p><em>News:</em> I received the <a class="link" href="https://bowers.cornell.edu/news-stories/you-are-holding-pen-1300-bowers-graduates-honored-recognition-ceremonies">Cornell Bowers 2026 Computer Science Prize for Academic Excellence</a>! I was also awarded (but declined) the <a class="link" href="https://www.nsfgrfp.org/">NSF Graduate Research Fellowship</a>.</p></section> <section id="publications" class="layout-md mb-14 scroll-mt-24"><h2 class="heading2">Publications</h2> <p class="text-neutral-500 mb-4">See my <a href="https://scholar.google.com/citations?user=y0B6gawAAAAJ&amp;hl=en" class="link">Google Scholar</a> for the most up-to-date list.</p> <div class="tab-bar svelte-1uha8ag"><button${attr_class("tab-btn svelte-1uha8ag", void 0, { "active": activeTab === "selected" })}>Selected</button> <button${attr_class("tab-btn svelte-1uha8ag", void 0, { "active": activeTab === "all" })}>All</button></div> `);
    {
      $$renderer2.push("<!--[-->");
